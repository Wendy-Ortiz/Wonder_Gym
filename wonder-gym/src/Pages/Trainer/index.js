    ...
    return (
        <>
            ...
            <div className="bg-white w-full">
                <br></br>
                <h1 className="flex items-center px-8 md:px-12 lg:px-24 font-bold text-2xl md:text-3x1 lg:text-4xl" id="username"> ¡HOLA {/*user.user.name*/}! </h1>
                <br></br>
                <h2 className= "flex items-center px-8 md:px-12 lg:px-24 font-bold text-main-blue text-base md:text-lg lg:text-xl" id="trainerSubTittle">¿QUÉ DESEAS REVISAR HOY?</h2>
                <br></br>
            </div>
