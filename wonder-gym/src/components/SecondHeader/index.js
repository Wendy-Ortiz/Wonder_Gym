                ...
                return <div key={input.id} className="bg-white h-36">
                    ...
                    <div  className="flex w-full px-8 md:px-12 lg:px-24">
                        <div className="flex items-center w-10/12">
                            ...
                            <h1 className="flex items-center font-bold text-3xl md:text-4x1 lg:text-5xl text-main-blue" id="tittle"> {input.title} </h1>
                        </div>
                                    ...
                                    <form className="flex w-full px-8 md:px-12 lg:px-24 items-center justify-end">     
                                        ...
                                        <div className="relative">
                                            ...
                                            <button type="submit" className="focus:ring-4 focus:ring-main-blue font-medium rounded-lg text-sm px-2 py-1"> 
                                                <svg className="w-5 h-5 text-gray-500 dark:text-main-blue" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="4" d="M21 21l-6-6m2-5a7 7 0 11-14 0 7 7 0 0114 0z"></path></svg>
                                            </button>
                                        </div>      
                                    </form>
